function [Sxx, w, N] = psd_experimental_fft_hanning(sys, u_turb,T,dt)

% File based on Example 7.4b, Aircraft Responses to Atmospheric Turbulence (exampl74b.m)
% This function computes the experimental periodogram with window function
...
y_1 = y_1 .* hanning(N); % set to zero the samples at the beginging and end of the observation (w/ cosine function)
